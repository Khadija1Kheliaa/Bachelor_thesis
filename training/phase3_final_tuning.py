...
# 2. WINNER PARAMETERS FROM PHASE 2
SCALING_METHOD = "log_and_z"
WEIGHT_TYPE = "none"
...
EPOCHS = 100
SEED = 42
log_file = "data/phase3_results.csv"
# ==========================================
...
# Apply Scaling (Log +z )
print("    Applied Scaling: log + Z score ")
...
print(f"\n Fine-tuning: Dims={HIDDEN_DIMS} | LRs={LEARNING_RATES} | Drops={DROPOUTS} | WDs={WEIGHT_DECAYS}")
    ...
    for lr in LEARNING_RATES:
        for drop in DROPOUTS:
            for wd in WEIGHT_DECAYS:
                ...
                # Final Test Metrics (with best threshold)
